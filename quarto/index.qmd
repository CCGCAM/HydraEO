...
sites <- data.frame(
site = c("Pistachio orchards", "Olive orchard", "Potato crop", "Alfafa trial", "Vineyard (Flavescence dorée) - Chianti"),
lat  = c(39.031111, 39.033333, 52.545556, 45.011667, 43.496033),
lon  = c(-3.944722, -3.945000,  5.543611, 10.863333, 11.408287),
img  = c("../assets/figure_pistachio.png",
"../assets/figure_olives.png",
"../assets/figure6.png",
"../assets/Alfafa_crops.png",
"../assets/aerials/Italy/Chianti.png"),
...
lng2 = max(sites$lon), lat2 = max(sites$lat)
    ...
    function(el, x) {
      ...
      map.on('popupopen', function(e) {
        map.setView(e.popup.getLatLng(), 14);
      });
    }
  ")
