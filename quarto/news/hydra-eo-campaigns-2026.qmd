...
(WU-DES)** team — through the [Laboratory of Geo-Information Science and
Remote Sensing](https://www.wur.nl/en/chair-groups/geo-information-science-and-remote-sensing)
— conducted five HYDRA-EO UAV campaigns between May and July 2026 over
experimental potato fields. Flights on **11 May, 16 June, 25 June, 1 July, and
21 July** followed crop development from early growth through flowering and
...
susceptibility to viral and bacterial diseases. The primary disease targets
are *Potato virus Y (PVY)* and *Erwinia* spp., associated with bacterial
soft rot and blackleg, with *Potato Leaf Curl Virus* monitored as a
secondary viral target. The trial combines different varieties with known
disease positions and treatments, which is especially valuable for studying
how the spectral and physiological signal changes with variety, disease, and
time in the season — including the interaction between viral and bacterial
pathogens and variability in soil moisture. Comparing variety- and
disease-specific plots throughout the season allows the team to relate
visible symptom development to the spectral and thermal signals captured from
the UAV and satellite platforms.
...
In Ciudad Real, the olive disease work focuses primarily on *Spilocaea
oleaginea* (peacock spot) and *Pseudomonas savastanoi pv. savastanoi*
(olive knot). *Bactrocera oleae* (olive fruit fly) is treated as a secondary
target, monitored when confirmed field incidence is present. The design
includes plots under different soil management regimes, together with a
dedicated plot of nine olive varieties, allowing the team to compare
differences in stress response driven by management practice versus variety.
This work is also connected to other European surveillance systems for
*P. savastanoi* and *B. oleae*.

For pistachio, the two primary disease groups are *Septoria* spp. and fungi
of the *Botryosphaeriaceae* family, with *Alternaria alternata* and
*Botrytis cinerea* monitored as secondary targets. The pistachio
experiments span a wide diversity of varieties and rootstocks under
contrasting rainfed and irrigated management, and the project aims to
integrate hyperspectral phenotyping with genetic and GWAS data — connecting
molecular, genomic, and spectral information in pistachio and olive is one of
the scientific gaps HYDRA-EO aims to address.

::: {.campaign-lead}
For this summer's analysis, the initial disease classes are being kept
simple: **Healthy → Primary disease 1 → Primary disease 2 → Other disease/pest
→ Unknown/abiotic stress.** This avoids forcing trees or plants with
unconfirmed symptoms into a specific named disease, and lets the classes be
cross-referenced with traits such as Cab, Car, Anth, N, LWC, gs, temperature,
and SIF.
:::
...
larger spatial scales. Disease status in the vineyards is confirmed through
qPCR testing and visual inspection, with **CNR-IBE** and the **University of
Florence** as the groups involved in this ground-truthing work.
...
On **2 September 2026**, a joint field team from **CNR-IBE** and the
**Department of Agricultural and Food Sciences, University of Bologna**
carried out ground measurements in the CERBERUS vineyards, combining field
spectroradiometer readings, SPAD (leaf chlorophyll) measurements, and visual
disease inspection. This ground-truthing adds another point to the
*Flavescence dorée* time series and supports the interpretation of the
airborne hyperspectral and thermal acquisitions collected over the same
vineyards.

::: {.campaign-photo .campaign-photo-wide}
![](../../assets/aerials/Cerberus/Collavorations.png){fig-alt="Collage of the CERBERUS field campaign in Bologna vineyards on 2 September 2026: a team walking between vine rows, SPAD chlorophyll measurement on a grape leaf, a spectroradiometer measurement on the canopy, and a researcher recording a visual disease assessment"}

**CERBERUS field campaign, 2 September 2026.** The CNR-IBE and University of Bologna team taking spectroradiometer, SPAD, and visual disease measurements in the vineyards near Bologna.
:::
